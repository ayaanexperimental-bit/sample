...
test.describe("security headers", () => {
  test("has strict CSP, HSTS, and no-store admin dashboard headers", () => {
    ...
    expect(headers).toContain("script-src 'self' 'unsafe-inline' 'wasm-unsafe-eval' https://static.cloudflareinsights.com");
    ...
    expect(headers).toContain(
      "connect-src 'self' blob: https://ywcoach.com wss://ywcoach.com https://cloudflareinsights.com https://static.cloudflareinsights.com"
    );
